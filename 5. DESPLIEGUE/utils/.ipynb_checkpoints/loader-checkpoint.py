...
def load_resources():
    try:
        # Cargar Pipeline
        try: pipeline = joblib.load('../DATOS/pipeline_final_aumentado_xgb.pkl')
        except: 
            try: pipeline = joblib.load('../DATOS/pipeline_final_aumentado_gbr.pkl')
            except: pipeline = joblib.load('../DATOS/pipeline_final_aumentado_rf.pkl')
            
        model_cols = joblib.load('../DATOS/features_columns_augmented.pkl')
